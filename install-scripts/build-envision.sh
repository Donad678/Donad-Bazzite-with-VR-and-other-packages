...
dnf5 install -y --setopt=tsflags=noscripts --setopt=disable_excludes=* cmake gcc eigen3-devel gcc-c++ git-lfs glslang-devel glslc libbsd-devel mesa-libGL-devel systemd-devel libX11-devel libxcb-devel libXrandr-devel ninja-build opencv-devel openxr-devel vulkan-devel vulkan-loader-devel wayland-devel wayland-protocols-devel vulkan-headers glslc --best --allowerasing
...
dnf5 install -y mesa-libgbm-devel libglvnd-devel libdav1d-devel libinput-devel
