...
# desktop dependencys
dnf5 install -y cmake eigen3-devel gcc-c++ git-lfs glslang-devel glslc libbsd-devel mesa-libGL-devel systemd-devel libX11-devel libxcb-devel libXrandr-devel ninja-build opencv-devel openxr-devel SDL3-devel vulkan-devel vulkan-loader-devel wayland-devel wayland-protocols-devel
